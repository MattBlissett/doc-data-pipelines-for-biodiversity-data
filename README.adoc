...
https://builds.gbif.org/job/doc-data-pipelines-for-biodiversity-data/lastBuild/console[image:https://builds.gbif.org/job/doc-data-pipelines-for-biodiversity-data/badge/icon[Build status]]
